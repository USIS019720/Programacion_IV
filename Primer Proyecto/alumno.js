                    ...
                    <form method="post" @submit.prevent="guardarAlumno" @reset="nuevoAlumno">
                        <div class="row p-1">
                            ...
                            <div class="col col-md-2">
                                <input title="Ingrese el codigo" v-model="alumno.codigo" pattern="[A-Z0-9]{3,10}" required type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row p-1">
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col col-md-3">
                                <input title="Ingrese el Apellido" v-model="alumno.apellido" pattern="[A-Za-zñÑáéíóúü ]{3,100}" required type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row p-1">
                            <div class="col col-md-2">Fecha de Nacimiento:</div>
                            <div class="col col-md-2">
                                <input title="Ingrese la fecha de Nacimiento" v-model="alumno.nacimiento" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" required type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row p-1">
                            <div class="col col-md-2">Direccion:</div>
                            <div class="col col-md-2">
                                <input title="Ingrese la Direccion" v-model="alumno.direccion" pattern="[A-Za-z0-9Ññáéíóú ]{3,100}" required type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row p-1">
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col col-md-2">
                                <input title="Ingrese el correo" v-model="alumno.correo" pattern="[A-Za-zÑñáéíóú@gmail.com ]{3,75}" required type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row p-1">
